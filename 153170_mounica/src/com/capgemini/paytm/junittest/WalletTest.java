...
public class WalletTest {
	...
	public void initData() {
		...
		cust1 = new Customer("Mounica", "9900112212", new Wallet(new BigDecimal(9000)));
		cust2 = new Customer("Bhuvija", "9963242422", new Wallet(new BigDecimal(6000)));
		cust3 = new Customer("Ravi", "9922950519", new Wallet(new BigDecimal(7000)));
	...
	public void testCreateAccount1() {
		...
		cust = service.createAccount("Mounica", "9900112213", new BigDecimal(7000));
